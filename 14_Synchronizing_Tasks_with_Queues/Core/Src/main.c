...
int main(void)
{
  ...
  // Create two Sender tasks of the same priority, lower than the receiver task priority.
  // By giving them the same priority, they are synchronized, because they
  // alternate sending 50% SenderTask1 and 50% SenderTask2.
  ...
  xTaskCreate(SenderTask2,
              ...
              1,
              &sender_handle);
  // Create Receiver Task of a higher priority
